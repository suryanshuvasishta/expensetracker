...
import { Settings as SettingsIcon, Sun, Moon, Wallet, Quote } from 'lucide-react';
        ...
        <div className="card" style={{ display: 'flex', gap: '0.75rem' }}>
          <button
            ...
            style={{
              ...
              padding: '0.875rem', borderRadius: '10px', border: 'none', cursor: 'pointer',
              background: 'var(--bg-elevated)', color: 'var(--text-primary)', fontSize: '0.875rem', fontWeight: 500,
            }}
          >
